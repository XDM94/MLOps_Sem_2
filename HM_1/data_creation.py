...
os.makedirs('/home/sturmtrooper/data/train', exist_ok=True)
os.makedirs('/home/sturmtrooper/data/test', exist_ok=True)
...
pd.DataFrame({'day': train_days, 'temperature': train_temps}).to_csv('/home/sturmtrooper/data/train/train_data.csv', index=False)
pd.DataFrame({'day': test_days, 'temperature': test_temps}).to_csv('/home/sturmtrooper/data/test/test_data.csv', index=False)