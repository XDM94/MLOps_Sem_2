...
### Ссылки
- [Облачное хранилище датасетов](https://drive.google.com/drive/folders/1xY0gkFbuobhza2BuBbu8NXLgZykuyU4l?usp=sharing)



### Дополнения
Команды для переключения между версиями датасета
```
git log --oneline
